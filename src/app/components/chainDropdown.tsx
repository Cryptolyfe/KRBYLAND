  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="px-2 py-1 text-xs text-white border-2 border-white rounded-full bg-transparent transition-colors cursor-pointer hover:bg-gradient-to-r hover:from-pink-500 hover:to-yellow-500 hover:text-transparent hover:bg-clip-text"
      >
        {selectedChainName}
      </button>
      {open && (
